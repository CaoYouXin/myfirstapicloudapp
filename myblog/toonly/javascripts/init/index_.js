    ...
    require(['jquery'], function ($) {
        $(function () {
            window.top.require(['handlebars', 'toonly/javascripts/only-router'], function (Handlebars, router) {
                ...
                $.getJSON('http://caoyouxin.github.io/myblog/articles.json', function (data) {
                    $.get('http://caoyouxin.github.io/myblog/toonly/x-handlebars-templates/article_list.html', function (tpl) {
